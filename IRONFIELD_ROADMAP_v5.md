# IRONFIELD — Development Roadmap v5
*Updated: 2026-04-05*
...
- Single HTML file (`index.html`), ~3920 lines, no build step
...
**⚠ PLAYTESTING RECOMMENDED** — The core game is now feature-complete for a meaningful skirmish: terrain, elevation, heat, pilot skills, lance composition, and a full combat system. Before adding more features, a playtesting session is warranted to assess: balance (are scouts useful? is the point budget right?), feel (is WeGo resolution satisfying?), and roadmap priority (does VS AI matter more than more chassis?).

**Post-playtest options:**
...
2. **Additional chassis + weapons (3.1/3.2)** — More variety in the lance picker. Can be done incrementally.
3. **VS AI — Hard difficulty with Claude API** — Prompt board state JSON, receive plan object.
4. **Campaign mode (Tier 5)** — Largest remaining scope; multi-session. Depends on playtest verdict on pilot progression feel.
5. **Quality of life (Tier 6)** — Replay system, turn timer, sound — all polish items; prioritise after core is proven fun.
